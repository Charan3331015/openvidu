...
class VideoRoomComponent extends Component {
    constructor(props) {
        ...
        this.layout = new OpenViduLayout();   //Default Layout (@see def. in '../layout/openvidu-layout.js' file)
        let sessionName = this.props.sessionName ? this.props.sessionName : 'SessionA';
        let userName = this.props.user ? this.props.user : 'Rand_User' + Math.floor(Math.random() * 100);
        this.remotes = [];
        ...
        this.camSwitch = this.camSwitch.bind(this);
        this.getCamerasList = this.getCamerasList.bind(this);
    ...
    componentDidMount() {
        const openViduLayoutOptions = {
            ...
            bigClass: 'OV_big', // The class to add to elements that should be sized bigger   //<<<<<---- here it is the BIGGER class
        ...
        this.layout.initLayoutContainer(document.getElementById('layout'), openViduLayoutOptions); // <div id='layout'> ..here all streams </div>
    ...
    onbeforeunload(event) {
        this.leaveSession(); //closed the connection before destructing layout streams
    }
    ...
    async camSwitch () {
        ...
        this.connectWebCam(newDevice.deviceId)
    }
...
console.log("screen share111",localUser.getStreamManager().stream.streamId)
    ...
    //     demo.classList.add("flex-containerDemo");
    //     demo.classList.remove("flex-container");
    //     //demo.classList.add("localUser")
    //     var demodemo = document.getElementById("demodemo");
    //     demodemo.classList.add("OT_widget-containerDemo");
    //     demodemo.classList.remove("OT_widget-container");
    //    // demodemo.classList.remove("localUser") 
        ...
        return (
            <div className="container" id="container">
                <ToolbarComponent
                    ...
                    getCamerasList={this.getCamerasList}
