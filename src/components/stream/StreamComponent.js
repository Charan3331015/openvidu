...
export default class StreamComponent extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div id="demodemo" onClick={this.handleClick}  className={(this.props.isSelectedStream ? (this.props.selectedStreamID==this.props.user.getStreamManager().stream.streamId || (this.props.user.isLocal() && this.props.iscamswitch)) ? 'col-12': 'OT_widget-containerDemo' : 'col')}>
	             {/* BEG: nickname BOX */}
